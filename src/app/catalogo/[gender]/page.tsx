        ...
        {Object.entries(grouped).map(([style, items]) => (
          <div key={style}>
            ...
            <div className="flex items-center gap-2 mb-3">
              ...
              <h2 className="text-xs font-bold uppercase tracking-wider whitespace-nowrap" style={{ color: '#D4AF37' }}>
                {styleLabels[style] || style}
              </h2>
              <span className="text-[10px] px-2 py-0.5 rounded-full" style={{ color: '#555', background: '#1a1a1a' }}>
                {items.length}
              </span>
              <div className="h-px flex-1" style={{ background: '#222' }} />
            </div>

            {/* Product grid - 4 per row on desktop, 2 on mobile */}
